#ifndef HDRLIB_CERTAINTY_MERGE_UNI_BAYER_HPP_
#define HDRLIB_CERTAINTY_MERGE_UNI_BAYER_HPP_
...
class CertaintyMergeUniBayer : public ComposerInterface
{
private:
...
public:
	CertaintyMergeUniBayer(){ sigma = 0; invSigmaSquare = 0;};

     virtual ~CertaintyMergeUniBayer(){};
...
#endif /* HDRLIB_CERTAINTY_MERGE_UNI_BAYER_HPP_ */
